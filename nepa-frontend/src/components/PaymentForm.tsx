...
export const PaymentForm = ({ onSubmit, isLoading }: any) => {
  ...
  return (
    <form onSubmit={(e) => { e.preventDefault(); onSubmit(formData); }} className="space-y-4">
      <div>
        <label className="block text-[10px] font-bold text-slate-400 uppercase">Meter ID</label>
      ...
      <div>
        <label className="block text-[10px] font-bold text-slate-400 uppercase">Amount (XLM)</label>
