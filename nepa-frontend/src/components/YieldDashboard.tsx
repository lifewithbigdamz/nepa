  ...
  return (
    <div className="p-6 bg-gray-50 min-h-screen">
      <div className="max-w-7xl mx-auto">
        {/* Header */}
        <div className="mb-8">
          <h1 className="text-3xl font-bold text-gray-900 mb-2">Yield Generation Dashboard</h1>
          <p className="text-gray-600">Monitor and manage your DeFi yield positions</p>
        </div>
        ...
        <div className="grid grid-cols-1 md:grid-cols-4 gap-6 mb-8">
          <div className="bg-white rounded-lg shadow p-6">
            ...
            <p className="text-2xl font-bold text-gray-900">{formatYield(totalInvested)}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-sm font-medium text-gray-500 mb-2">Total Earned</h3>
            <p className="text-2xl font-bold text-green-600">{formatYield(totalEarned)}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-sm font-medium text-gray-500 mb-2">Current APR</h3>
            <p className="text-2xl font-bold text-blue-600">{formatPercentage(currentAPR)}</p>
          </div>
          <div className="bg-white rounded-lg shadow p-6">
        ...
        <div className="grid grid-cols-1 lg:grid-cols-2 gap-6 mb-8">
          {/* Yield Over Time */}
          <div className="bg-white rounded-lg shadow p-6">
            <h3 className="text-lg font-semibold mb-4">Yield Performance</h3>
                ...
                <tbody>
                  {positions.map((position) => (
                    <tr key={position.id} className="border-b">
                      <td className="py-2 text-sm">{position.strategy}</td>
                      <td className="text-right py-2 text-sm">{formatYield(position.amount)}</td>
                      <td className="text-right py-2 text-sm">{formatPercentage(position.apr)}</td>
                      <td className="text-right py-2 text-sm">{formatYield(position.earnedYield)}</td>
